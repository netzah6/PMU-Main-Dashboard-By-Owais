...
export const FORM_FIELDS: { key: string; label: string; required?: boolean; long?: boolean }[] = [
  ...
  { key: "logo_url", label: "Funnel Logo (image URL)" },
  { key: "studio_pic_1", label: "Picture of Studio 1 (image URL)" },
  { key: "studio_pic_2", label: "Picture of Studio 2 (image URL)" },
  { key: "studio_pic_3", label: "Picture of Studio 3 (image URL)" },
  { key: "eyebrows_ba_1", label: "Eyebrows Before & After 1 (image URL)" },
  { key: "eyebrows_ba_2", label: "Eyebrows Before & After 2 (image URL)" },
  { key: "eyebrows_ba_3", label: "Eyebrows Before & After 3 (image URL)" },
  { key: "lipblush_ba_1", label: "Lip Blush Before & After 1 (image URL)" },
  { key: "lipblush_ba_2", label: "Lip Blush Before & After 2 (image URL)" },
  { key: "lipblush_ba_3", label: "Lip Blush Before & After 3 (image URL)" },
  { key: "eyeliner_ba_1", label: "Eyeliner Before & After 1 (image URL)" },
  { key: "eyeliner_ba_2", label: "Eyeliner Before & After 2 (image URL)" },
  { key: "eyeliner_ba_3", label: "Eyeliner Before & After 3 (image URL)" },
