                ...
                <div key={section} className="break-inside-avoid mb-2.5">
                  ...
                  <ul className="space-y-0.5">
                    {secSteps.map((s) => {
                      ...
                      const showPassDetail = c.status !== "fail" && !!c.detail && ["wf_area", "user_add", "wf_assign", "user_permissions", "user_phone", "cal_availability", "fin_test", "make_filter", "make_http", "funnel_lead_pixel", "fin_master", "funnel_map", "form_pictures"].includes(s.key);
