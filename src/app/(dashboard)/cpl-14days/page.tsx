...
export default function Cpl14DaysPage() {
  const { data, loading, error } = useTableData<Record<string, unknown>>({ table: "cpl_14days" });
  ...
  return (
    <div className="p-6 space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-lg font-semibold text-[#1f3559]">CPL — 14 Days</h1>
      ...
      <AutoTable data={filtered} loading={loading} error={error} exportFilename="cpl-14days.csv" />
    </div>
  );
}
