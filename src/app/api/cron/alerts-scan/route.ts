...
import { scanComplianceSynced, scanComplianceDeep, scanMakeScenarios, scanOnboardingPipeline, scanDuplicateLeads, scanIngestHealth } from "@/lib/alerts";
...
export async function GET(req: NextRequest) {
  ...
  const [synced, deep, make, onboarding, dupes, ingest] = [
  ...
  return NextResponse.json({ timestamp: new Date().toISOString(), synced, deep, make, onboarding, dupes, ingest });
}
