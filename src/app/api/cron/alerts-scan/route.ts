...
import { scanComplianceSynced, scanComplianceDeep, scanMakeScenarios, scanOnboardingPipeline, scanDuplicateLeads, scanIngestHealth, scanAgreementMissing } from "@/lib/alerts";
...
export async function GET(req: NextRequest) {
  ...
  const [synced, deep, make, onboarding, dupes, ingest, agreement] = [
  ...
  return NextResponse.json({ timestamp: new Date().toISOString(), synced, deep, make, onboarding, dupes, ingest, agreement });
}
