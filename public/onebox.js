...
(function () {
  ...
  var css = "" +
    ...
    /* Bar color per Netzah (2026-09-16): exactly #1cc4c7. */
    "#ob-v2bar{position:fixed;top:0;left:0;right:0;z-index:60;display:none;align-items:center;justify-content:center;gap:12px;padding:9px 12px;background:#1cc4c7;color:#fff;font-family:var(--form);font-size:13.5px;font-weight:600;box-shadow:0 4px 14px -6px rgba(0,0,0,.35)}" +
